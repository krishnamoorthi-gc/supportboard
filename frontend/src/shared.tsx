...
export const API_BASE = `${import.meta.env.VITE_BACKEND_URL??"http://localhost:4002"}/api`;
...
export function NavIcon({id,s=20,col}){
  ...
  const icons={
    ...
    users:<svg style={st} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="7" r="3.5"/><path d="M3 21v-2c0-2.76 2.69-5 6-5s6 2.24 6 5v2"/><circle cx="18" cy="8" r="2.5"/><path d="M21 21v-1.5c0-1.8-1.34-3.3-3.2-3.9"/></svg>,
